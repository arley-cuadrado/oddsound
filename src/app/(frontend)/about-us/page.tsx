...
const sections = [
  {
    ...
    body: [
      ...
      <em className="text-[16px] font-bold" key="about-us-quote">
        “Hey estoy aquí, llégate! Sube tu info y lanzamientos si quieres, si puedes y si te da la
  ...
  },
  {
    ...
    body: [
      <>
        ...
        <Link className="underline underline-offset-2 title" href="mailto:hello@oddsound.co">
          hello@oddsound.co
        </Link>
