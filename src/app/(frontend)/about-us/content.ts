export const aboutUsDateTime = '2026-05-16'
export const aboutUsUpdatedAt = '16 de mayo de 2026'
export const aboutUsIntroTitle = 'Bueno, ¿por qué Oddsound existe?'
export const aboutUsTitle = 'Por qué Oddsound?'
