...
export const HeaderNav: React.FC<{ data: HeaderType }> = ({ data }) => {
  ...
  return (
    ...
    >
      <div
        className="max-[975px]:pointer-events-auto max-[975px]:fixed max-[975px]:left-0 max-[975px]:z-30 max-[975px]:w-full max-[975px]:bg-white max-[975px]:px-4 max-[975px]:py-1.5 max-[975px]:dark:bg-[#0f0f0f]"
        style={{ top: 'var(--admin-bar-offset, 0px)' }}
      >
